...
namespace CodeRacer.Controllers
{
    public class CompetitionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] Competition competition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] Competition competition)
        {
